...
var dbFixture = require('./helpers/dbfixture.js')(dbConnection);
var _ = require('underscore');
var chai = require('chai');
var should = chai.should();
var chaiHelper = require('./helpers/chai.js');
...
describe('bistro-service', function() {
    ...
    describe('operations on /articles', function(){
        before(function (done) {
            dbFixture.clearCollections(['articles', 'limits'], done);
        });
